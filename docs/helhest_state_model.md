...
Helhest Junior defaults (source: [`src/kinematic_helhest/model.py`](../src/kinematic_helhest/model.py) and [`src/kinematic_helhest/dynamics.py`](../src/kinematic_helhest/dynamics.py)):
